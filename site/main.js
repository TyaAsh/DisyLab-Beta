...
const localeContent = {
  "zh-CN": {
    ...
    localTitle: "你的创作，<br>先属于你的设备。", localText: "项目、资产、历史和 Agent 会话默认保存在浏览器本机。API Key 不进入项目导出包，也不需要交给 DisyLab 的服务器。", local1: "浏览器本地存储", local2: ".disy 完整项目包", local3: "API Key 独立保存", roadmapTitle: "画布还会继续生长。", roadmapText: "DisyLab 聚焦视觉创作：从图片到视频，从单人工作台到可分享的创作空间。", road1Title: "工作流与完整视频创作闭环", road1Text: "工作流模板、视频生成、剪辑、裁剪、截帧与视频资产管理。", road2Title: "3D 预演台", road2Text: "在生成之前预演镜头、场景、角色站位与空间关系。", road3Title: "Skill 集成", road3Text: "把可复用的专业能力接入 Agent 与结构化创作工作流。", road4Title: "平台、语言与主题", road4Text: "前后端分离和桌面端正在开发；多语言、深色与浅色模式将逐步开放。", closingTitle: "让下一张画面，<br>从一张会思考的画布开始。", closingStart: "开始创作", closingRepo: "查看仓库", footerText: "源码公开可见，但未经书面许可禁止商用、白标与再分发。", footerLicense: "授权说明 ↗"
  },
  "zh-TW": {
    ...
    localTitle: "你的創作，<br>先屬於你的裝置。", localText: "專案、資產、歷史和 Agent 會話預設儲存在瀏覽器本機。API Key 不進入專案匯出包，也不需要交給 DisyLab 的伺服器。", local1: "瀏覽器本機儲存", local2: ".disy 完整專案包", local3: "API Key 獨立儲存", roadmapTitle: "畫布還會繼續生長。", roadmapText: "DisyLab 聚焦視覺創作：從圖片到影片，從單人工作台到可分享的創作空間。", road1Title: "工作流與完整影片創作閉環", road1Text: "工作流範本、影片生成、剪輯、裁剪、截幀與影片資產管理。", road2Title: "3D 預演台", road2Text: "在生成之前預演鏡頭、場景、角色站位與空間關係。", road3Title: "Skill 整合", road3Text: "把可重用的專業能力接入 Agent 與結構化創作工作流。", road4Title: "平台、語言與主題", road4Text: "前後端分離與桌面端正在開發；多語言、深色與淺色模式將逐步開放。", closingTitle: "讓下一張畫面，<br>從一張會思考的畫布開始。", closingStart: "開始創作", closingRepo: "查看倉庫", footerText: "原始碼公開可見，但未經書面許可禁止商用、白標與再散布。", footerLicense: "授權說明 ↗"
  },
  en: {
    ...
    localTitle: "Your work belongs<br>on your device first.", localText: "Projects, assets, history, and Agent conversations stay in your browser by default. API keys never enter exported project packages or DisyLab servers.", local1: "Browser-local storage", local2: "Complete .disy packages", local3: "API keys stored separately", roadmapTitle: "The canvas keeps growing.", roadmapText: "DisyLab is expanding from images to video, and from a personal desk to shareable creative spaces.", road1Title: "Workflow + complete video loop", road1Text: "Workflow templates, video generation, trimming, cropping, frame capture, and video assets.", road2Title: "3D Previsualization Stage", road2Text: "Previsualize cameras, scenes, character blocking, and spatial relationships before generation.", road3Title: "Skill integration", road3Text: "Bring reusable professional capabilities into the Agent and structured creative workflows.", road4Title: "Platforms, languages, and themes", road4Text: "Frontend/backend separation and desktop are in development; more languages plus dark and light modes will roll out gradually.", closingTitle: "Let the next frame begin<br>on a canvas that can think.", closingStart: "Start creating", closingRepo: "View repository", footerText: "Source-visible proprietary software. Commercial use, white-labeling, and redistribution require written permission.", footerLicense: "License terms ↗"
  }
};
